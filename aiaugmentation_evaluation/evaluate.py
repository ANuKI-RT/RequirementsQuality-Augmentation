...
def experiment_evaluation(file:str):
    ...
    for ex in experiment_samples:
        ...
        print("--"*100)
        if user_inp not in ("j", "n", "d"):
            user_inp = input("Inacceptable key pressed. Press [j] for correct augmented, [n] for incorrect augmented or [d] for duplicate.")
            print("--"*100)
        else:
            ex.append(user_inp)
...
def evaluation_results_calculation(file:str):
    evaluation_samples = read.read_evaluated_json_files([file])
    ...
    # A maximum of 100 augmented requirements was expected in the experiment
    print("TOTAL DUPLICATES: ", 100-total_amount)
    ...
    print("EDA | Amount of data, which was incorrect augmented and was identified as being correct: ", total_right_incorrect_augmented_EDA)
    print("EDA | Amount of data, which was incorrect augmented and was identified as being wrong: ", total_wrong_incorrect_augmented_EDA)
    print("GPT | Amount of data, which was incorrect augmented and was identified as being correct: ", total_right_incorrect_augmented_GPT)
    print("GPT | Amount of data, which was incorrect augmented and was identified as being wrong: ", total_wrong_incorrect_augmented_GPT)