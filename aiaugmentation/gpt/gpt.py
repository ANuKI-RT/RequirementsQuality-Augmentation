...
def gpt(data):
    ...
    train_dataset, val_dataset = random_split(dataset, [train_size, val_size]) # randomly splits datasets into train- and validation-dataset, based on calculated numerical input [train_size, val_size].
    ...
    # match tokenizer and model tensors (otherwise there would be mismatch because of new tokens)
    ...
    # produce sample output in console at stated number
    sample_every = 100
    ...
    for epoch_i in range(0, epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if torch.cuda.is_available():
                ...
                b_labels = batch[0]
                b_masks = batch[1]
                print('batch index: ', step)
                print('batch size: ', batch[0].size())
                # print('batch label/input_ids: ', batch[0])
                # print('batch masks: ', batch[1])
    ...
    # Saving model
    # in case output directory is not available
